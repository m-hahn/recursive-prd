...
##############
modules_memory = [memory_mlp_inner, memory_mlp_outer, memory_mlp_inner_from_pos, positional_embeddings, perword_baseline_inner, perword_baseline_outer, memory_word_pos_inter, memory_bilinear]
...
#      print(numeric_transformed.size(), embedded_everything.size())
      ...
      attention_bilinear_term = torch.bmm(memory_bilinear(embedded_positions), memory_byword_inner.transpose(1,2)).transpose(1,2)
      #print(
