...
import corpusIterator_Tabor2004
...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_Tabor2004_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Tabor2004.load(args.language, tokenize=True)
   print("Got data")
...
with open("output/Tabor2004_"+args.language+"_"+args.load_from, "w") as outFile:
