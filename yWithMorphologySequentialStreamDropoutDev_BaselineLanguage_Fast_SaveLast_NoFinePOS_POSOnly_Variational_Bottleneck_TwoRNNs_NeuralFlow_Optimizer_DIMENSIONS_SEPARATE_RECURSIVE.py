...
parser.add_argument("--lr", type=float, default=random.choice([0.00001, 0.00002, 0.00005, 0.00005,0.0001,0.0001,0.0001,0.0002, 0.001, 0.001,  0.001, 0.001]))
parser.add_argument("--input_dropoutRate", type=float, default=0.0)
parser.add_argument("--batchSize", type=int, default=128)
parser.add_argument("--horizon", type=int, default=20)
parser.add_argument("--beta", type=float, default=0.001)
parser.add_argument("--flow_length", type=int, default=1)
