...
import corpusIteratorWikiWords_COW
...
char_vocab_path = "/u/scr/mhahn/CORPORA/COW/decow16bx/GERMAN_COW/german-cow-word-vocab.txt"
...
for epoch in range(10000):
   print(epoch)
   training_data = corpusIteratorWikiWords_COW.training(args.language)
   print("Got data")
 ...
 #     break
   ...
   dev_data = corpusIteratorWikiWords_COW.dev(args.language)
   print("Got data")
