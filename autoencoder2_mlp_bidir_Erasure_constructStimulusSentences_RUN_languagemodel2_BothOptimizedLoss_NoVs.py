...
parser.add_argument("--load-from-autoencoder", dest="load_from_autoencoder", type=str, default=906167090) #652477745)
...
memoryFileName = "autoencoder2_mlp_bidir_Erasure_SelectiveLoss_Reinforce2_Tuning_Long_Both_Saving.py"
