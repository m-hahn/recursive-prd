...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+autoencoderFileName+"_code_"+str(args.load_from)+".txt")
...
with open("/u/scr/mhahn/recursive-prd/memory-upper-neural-pos-only_recursive_words/TEST-estimates-"+args.language+"_"+__file__+"_model_"+str(args.myID)+"_"+model+".txt", "w") as outFile:
