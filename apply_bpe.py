# ~/python-py37-mhahn apply_bpe.py --codes ~/scr/FAIR18/german-wiki-word-vocab_BPE_50000.txt --input ~/scr/FAIR18/german-wiki-word-vocab.txt  --output ~/scr/FAIR18/german-wiki-word-vocab_BPE_50000_Parsed.txt
...
class BPE(object):
    ...
    def process_line(self, line):
        ...
        if len(line2) == 2:
           out += self.segment(line2[0]) + "\t" + line2[1]
        else:
           print("ERROR", line2)
