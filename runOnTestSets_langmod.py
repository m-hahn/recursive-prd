...
scripts = []
scripts.append("char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words_NoNewWeightDrop_NoChars.py")
...
#           next(inFile)
           hyperparams = ["--"+x for x in next(inFile)[10:-2].split(", ") if "myID" not in x and "language" not in x and "load_from" not in x]
 #          print(hyperparams)
#       continue
