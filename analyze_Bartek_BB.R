...
data = read.csv("output/Bartek_BB_8066636", sep="\t")
...
summary(lmer(Surprisal ~ pp_rc * emb_c + someIntervention + (1 + pp_rc + emb_c + someIntervention|item), data=vb)) # finds RC >> PP, but NO evidence for someIntervention effect
