...
summary(fm4a <- lmer(Surprisal~ grammatical+interference+(1+grammatical|Model)+(1+grammatical|item), data=data %>% filter(region == "V3", grammatical!="full")))
summary(fm4a <- lmer(Surprisal~ grammatical+interference+(1+grammatical|Model)+(1+grammatical|item), data=data %>% filter(region == "V2", grammatical!="RemovedV2")))

# Both ungrammaticality manipulations show similar penalty in this surprisal.
summary(fm4a <- lmer(Surprisal~ grammatical+interference+(1+grammatical|Model)+(1+grammatical|item), data=data %>% filter(region == "D4", grammatical!="RemovedV1")))
summary(fm4a <- lmer(Surprisal~ grammatical+interference+(1+grammatical|Model)+(1+grammatical|item), data=data %>% filter(region == "D4", grammatical!="RemovedV2")))
