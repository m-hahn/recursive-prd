...
with open("results/models_vanillaLSTM_"+language+".tsv", "w") as outFile:
 for model in models:
   ...
   with open(path+model, "r") as inFile:
       ...
       for section in ["E1SPRlevykellerExp1.txt",  "E3SPRlevykellerExp2.txt",   "E5SPRlevykellerExp12.txt"]:
         command = ["/u/nlp/anaconda/main/anaconda3/envs/py37-mhahn/bin/python", "RUN_LK_"+script, "--language=german", "--load-from="+ID, "--section="+section]
