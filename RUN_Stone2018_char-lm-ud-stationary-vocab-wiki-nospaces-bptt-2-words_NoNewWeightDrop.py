...
assert args.section == "spr"

import corpusIterator_Stone2018
...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/GERMAN/"+args.language+"_"+__file__.replace("RUN_Stone2018_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Stone2018.load(args.language, section=args.section, tokenize=True)
   print("Got data")
...
with open("output/Stone2018"+args.section+"_"+args.language+"_"+args.load_from, "w") as outFile:
