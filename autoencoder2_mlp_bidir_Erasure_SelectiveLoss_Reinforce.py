...
optim = torch.optim.SGD(parameters_memory(), lr=learning_rate, momentum=0.0) # 0.02, 0.9
  ...
  #    print("NOISED", embedded_noised[1,2,])
   #   print("NOISED", embedded_noised[2,2,])
    ...
    #  print(embedded_noised.size())
      ...
      reinforceObjectiveTerm1 = (negativeRewards.detach() * bernoulli_logprob_perBatch).mean()
