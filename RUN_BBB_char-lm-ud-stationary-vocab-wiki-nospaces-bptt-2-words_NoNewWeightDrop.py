...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_BBB_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Bartek_BB_Py37.load(args.language, tokenize=True)
   print("Got data")
