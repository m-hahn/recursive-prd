...
parser.add_argument("--batchSize", type=int, default=random.choice([32, 64, 128]))
...
parser.add_argument("--weight_dropout_in", type=float, default=random.choice([0.05, 0.1, 0.15]))
parser.add_argument("--weight_dropout_out", type=float, default=random.choice([0.05, 0.1, 0.15]))
parser.add_argument("--char_dropout_prob", type=float, default=random.choice([0.01, 0.05]))
#parser.add_argument("--char_noise_prob", type = float, default=random.choice([0.0]))
parser.add_argument("--learning_rate", type = float, default= random.choice([0.8, 1.0, 1.2]))
parser.add_argument("--myID", type=int, default=random.randint(0,1000000000))
parser.add_argument("--sequence_length", type=int, default=random.choice([50]))
parser.add_argument("--verbose", type=bool, default=False)
parser.add_argument("--lr_decay", type=float, default=random.choice([0.95, 0.98, 1.0]))
