...
import corpusIterator_Frank_etal_2015
...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_Frank_etal_2015_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Frank_etal_2015.load(args.language, tokenize=True)
   print("Got data")
...
with open("output/Frank_etal_2015_"+args.language+"_"+args.load_from, "w") as outFile:
