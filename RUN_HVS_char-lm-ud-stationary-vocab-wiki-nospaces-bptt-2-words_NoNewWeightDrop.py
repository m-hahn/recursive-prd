...
parser.add_argument("--language", dest="language", type=str, default="hindi")
...
if True:
   ...
   test_data = corpusIterator_HVS.load(args.language, tokenize=True)
   print("Got data")
...
with open("output/HVS_"+args.load_from, "w") as outFile:
