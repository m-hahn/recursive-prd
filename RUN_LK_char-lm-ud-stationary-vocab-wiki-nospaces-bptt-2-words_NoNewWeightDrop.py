...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_LK_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIteratorLK.load(args.language, args.section, tokenize=True)
   print("Got data")
