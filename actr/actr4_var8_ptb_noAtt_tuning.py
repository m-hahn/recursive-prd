...
parser.add_argument("--hidden_dim", type=int, default=random.choice([512, 1024])) # 256, 
...
parser.add_argument("--learning_rate", type = float, default= random.choice([0.3, 0.5, 1.0, 2.0])) # 0.1, 0.15, 0.2, 
parser.add_argument("--myID", type=int, default=random.randint(0,1000000000))
parser.add_argument("--sequence_length", type=int, default=random.choice([30, 50]))
parser.add_argument("--verbose", type=bool, default=False)
parser.add_argument("--lr_decay", type=float, default=random.choice([0.98, 0.99, 1.0])) # 0.95, 
parser.add_argument("--lr_decay_after_failure", type=float, default=random.choice([0.8, 0.9, 1.0]))
