...
#          print(embeddedLast.size(), hidden.size())
          #print(out_decoder.size(), hidden.size())
...
#          print(attention_proj.weight.data)
          ...
          hidden = from_encoder
          outputsSoFar.append((toKeys(out_decoder), hidden))     # for retrieval
          fullOutputsSoFar.append(out_decoder) #torch.cat([out_decoder, retrieved], dim=2)) # for prediction
