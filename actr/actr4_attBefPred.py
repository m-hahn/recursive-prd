...
modules = [rnn_decoder, output, word_embeddings, attention_proj] # rnn_encoder, 
...
# Alternative: tree-structured GRU, where the retrieved elements themselves become the hidden state
