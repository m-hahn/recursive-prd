...
import corpusIterator_Chen2005
...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_Chen2005_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Chen2005.load(args.language, tokenize=True)
   print("Got data")
...
with open("output/Chen2005_"+args.language+"_"+args.load_from, "w") as outFile:
