...
assert __file__ == "char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words_NoNewWeightDrop_BPE_RunTest.py"
for options in ["char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words_NoNewWeightDrop_BPE_RunTest.py"]:
  try:
    if args.load_from is not None:
