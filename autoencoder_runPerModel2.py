...
print(models)
import subprocess
evScript = "autoencoder2_mlp_bidir_Erasure_constructStimulusSentences_RUN_languagemodel2_BothOptimizedLoss.py"
with open("autoencoder-output/perModelData2.tsv", "w") as outFile:
