...
import corpusIterator_Safavi2016
...
char_vocab_path = "vocabularies/"+args.language+"-wiki-word-vocab-50000.txt"
...
if args.load_from is not None:
  try:
     checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_Safavi2016_", "")+"_code_"+str(args.load_from)+".txt")
  except FileNotFoundError:
    try:
     checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+"char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words_NoNewWeightDrop_Farsi.py"+"_code_"+str(args.load_from)+".txt")
    except FileNotFoundError:
     checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+"char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words_NoNewWeightDrop_Search.py"+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Safavi2016.load(args.language, tokenize=True)
   print("Got data")
...
with open("output/Safavi2016_"+args.language+"_"+args.load_from, "w") as outFile:
