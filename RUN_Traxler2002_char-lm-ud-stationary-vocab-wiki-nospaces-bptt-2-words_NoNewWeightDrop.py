...
import corpusIterator_Traxler2002
...
if args.load_from is not None:
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS/"+args.language+"_"+__file__.replace("RUN_Traxler2002_", "")+"_code_"+str(args.load_from)+".txt")
...
if True:
   ...
   test_data = corpusIterator_Traxler2002.load(args.language, args.section, tokenize=True)
   print("Got data")
...
with open("output/Traxler2002_"+args.section+"_"+args.language+"_"+args.load_from, "w") as outFile:
